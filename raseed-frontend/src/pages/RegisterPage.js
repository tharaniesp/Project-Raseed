      ...
      <div className="login-illustration">
        <div className="wallet-graphic">
          <svg width="100%" height="100%" viewBox="0 0 400 400" fill="none">
            ...
            <circle cx="300" cy="280" r="20" fill="#4285F4" opacity="0.8"/>
            <path d="M290 280 L295 285 L310 270" stroke="white" strokeWidth="3" fill="none"/>
          </svg>
        </div>
        <div className="illustration-text">
          <h2>Join Smart Receipt Management</h2>
          <p>Create your account and start organizing your receipts with AI-powered insights</p>
        </div>
      </div>
      ...
      <div className="login-form-section">
        <div className="login-card">
          ...
          <div className="login-form-container">
            ...
            <p className="login-subtitle">Sign up to get started with smart receipt management</p>
